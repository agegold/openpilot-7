...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"OCurvSpeedUD", PERSISTENT},
    {"OSMCustomOffset40", PERSISTENT},
    {"OSMCustomOffset50", PERSISTENT},
    {"OSMCustomOffset60", PERSISTENT},
    {"OSMCustomOffset70", PERSISTENT},
    {"OSMCustomOffset90", PERSISTENT},
    {"OSMCustomOffsetUD", PERSISTENT},
